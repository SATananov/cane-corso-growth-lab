export const dictionaries = {
  en: {
    ...
    visualReview: {
      guide: {
        ...
        description:
          "Before a future neural model or visual similarity score is allowed, the app must know whether the photo is suitable. The guide defines what the user should upload and what the model should reject or mark as limited.",
      },
      criteria: {
  ...
  bg: {
    ...
    nav: {
      ...
      descriptions: {
        ...
        data: "Данни, еталони и логика на характеристиките",
    ...
    home: {
      chips: ["Координатна логика за растеж", "USG лабораторен интерфейс"],
      ...
      foundationDescription:
        "Регресия, класификация, групиране, създаване на характеристики, PCA и MLflow са представени като прозрачни методологични слоеве, а не като скрити непрозрачни твърдения.",
    },
    pageHeroes: {
      calculator: {
      ...
      data: {
        ...
        description:
          "Тази страница обяснява референтните извадки, обработените данни и създадените характеристики, използвани от методологичния слой. Целта е прозрачност: какво е включено, за какво се използва и къде са ограниченията.",
      ...
      visualReview: {
        ...
        description:
          "Визуалният модул обяснява какви снимки са подходящи, проверява готовността за сравнение и подготвя бъдещ наслагване между Cane Corso еталонната геометрия и качената снимка.",
        badge: "Фото критерии",
      },
      experiments: {
        eyebrow: "Методология",
        ...
        description:
          "Тази страница свързва приложението с методите зад него: регресия за криви, класификация за зони за преглед, групиране за профилни групи, PCA за визуални карти и MLflow проследяване за история на експериментите.",
      ...
      course: {
        ...
        description:
          "Тази страница държи проектната част ясна: показва как регресия, класификация, групиране, създаване на характеристики, намаляване на размерността и MLflow се демонстрират в приложението.",
    ...
    tables: {
      ...
      evaluationDescription:
        "Таблиците по-долу правят ML доказателствата по-лесни за преглед: регресията обяснява кривата на растежа, а класификацията подкрепя образователния сигнал за зона за преглед.",
      regressionTitle: "Сравнение на регресионни модели",
      regressionDescription:
        "По-ниски MAE/RMSE и по-високо R² са по-добри за този експеримент с крива на растежа.",
      classificationTitle: "Сравнение на класификационни модели",
      classificationDescription:
    ...
    visualReview: {
      guide: {
        ...
        description:
          "Преди бъдещ невронен модел или оценка за визуално сходство да бъде разрешен, приложението трябва да знае дали снимката е подходяща. Указанията определят какво трябва да качи потребителят и какво моделът трябва да отхвърли или маркира като ограничено.",
      },
      criteria: {
      ...
      workspace: {
        ...
        uploadTitle: "Качи снимка за преглед на готовността",
        uploadDescription:
      ...
      overlay: {
        eyebrow: "Концепция за наслагване",
      ...
      workflow: {
        ...
        title: "Проверката на снимката идва преди оценката за сходство.",
        safety:
      ...
      readinessTable: {
        ...
        headers: ["Ниво", "Диапазон", "Значение", "Действие в приложението"],
      },
    },
    about: {
      ...
      productBoundaries: [
        ...
        "Без реална система с потребителски акаунти в първата версия",
  ...
  it: {
    ...
    tables: {
      ...
      regressionHeaders: ["Modello", "Geometria", "Feature", "MAE", "RMSE", "R²", "Ruolo app"],
      classificationHeaders: [
        "Modello",
        "Geometria",
        "Accuratezza",
      ...
      featureFormulaEyebrow: "Logica delle feature",
      featureFormulaTitle:
    ...
    visualReview: {
      guide: {
        ...
        description:
          "Prima di autorizzare un futuro modello neurale o un punteggio di somiglianza visuale, l’app deve sapere se la foto è adatta. La guida definisce cosa caricare e cosa il modello deve rifiutare o marcare come limitato.",
      },
      criteria: {
