export const dictionaries = {
  ...
  bg: {
    ...
    home: {
      ...
      foundationDescription:
        "Регресия, класификация, групиране, feature engineering, PCA и MLflow са представени като прозрачни методологични слоеве, а не като скрити black-box твърдения.",
    },
    pageHeroes: {
      calculator: {
      ...
      course: {
        ...
        description:
          "Тази страница държи проектната част ясна: показва как регресия, класификация, групиране, feature engineering, dimensionality reduction и MLflow се демонстрират в приложението.",
