...
export const demoDogProfiles: DemoDogProfile[] = [
  {
    ...
    localized: {
      ...
      bg: {
        ...
        modelUse:
          "Подходящ за демонстрация на регресия, пълен вектор от характеристики и балансиран групов сигнал.",
  ...
  },
  {
    ...
    localized: {
      ...
      bg: {
        ...
        modelUse:
          "Подходящ за обяснение на степен на зрялост, референтно тегло като възрастен и стабилен класификационен сигнал.",
        tags: ["adult", "reference", "maturity"],
      },
      it: {
  ...
  },
  {
    ...
    localized: {
      ...
      bg: {
        ...
        modelUse:
          "Подходящ за демонстрация на класификационна граница, контролен списък и безопасни ограничения.",
        tags: ["review", "classification", "safety"],
      },
      it: {
