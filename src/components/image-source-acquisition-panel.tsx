...
const copy: Record<"en" | "bg" | "it", PanelCopy> = {
  ...
  bg: {
    ...
    note:
      "Това е план за събиране на dataset, не стъпка за автоматично сваляне. Снимки се използват само след проверка на права и обикновено не се commit-ват в Git.",
  },
  it: {
