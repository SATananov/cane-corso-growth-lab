...
const datasetCopy: Record<string, Partial<Record<LanguageCode, {
  ...
  "processed-public-growth-sample": {
    bg: {
      ...
      role: "По-широка референтна таблица за сравнение на модели, feature-space мислене и безопасни обобщения в приложението.",
      usedFor: [
        "Многоизмерни регресионни експерименти",
        "Изследване на feature space",
        "Сравнение на модели и бъдеща калибрация на приложението",
      ],
      qualityValues: {
        "methodology foundation and feature engineering": "методологична основа и feature engineering",
  ...
  "growth-classification-sample": {
    bg: {
      ...
      usedFor: [
        "Logistic Regression и tree-based класификация",
