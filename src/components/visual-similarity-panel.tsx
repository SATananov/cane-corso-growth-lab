...
const copy: Record<LanguageCode, {
  ...
  bg: {
    ...
    description:
      "Този слой подготвя бъдещото сравнение чрез снимкови векторни представяния: валидна потребителска снимка става визуален вектор от характеристики, сравнява се с разрешени Cane Corso референции и с обяснимия геометричен слой. Резултатът е сигнал за визуално сходство, не доказателство за родословие.",
    ...
    status: {
      ...
      dataset_required: "Нужен е набор от данни",
