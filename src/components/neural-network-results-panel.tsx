...
const copy: Record<LanguageCode, PanelCopy> = {
  en: {
    ...
    metrics: {
      accuracy: "Accuracy",
      precision: "Precision needs_attention",
      recall: "Recall needs_attention",
      f1: "F1 needs_attention",
    ...
    evidence: [
      "Training script: scripts/ml/train_growth_neural_network.py",
      "Notebook: notebooks/12_tabular_neural_network_growth_prediction.ipynb",
      "Report: reports/neural-network-growth-prototype.md",
      "Metrics JSON: reports/neural-network-growth-prototype-results.json",
    ],
  ...
  bg: {
    ...
    description:
      "Step 36 добавя обучен MLP neural-network prototype. Той работи със структурирани данни за растеж и дава безопасно образователно разделение между нормален растеж и проби, които имат нужда от внимание.",
    badge: "Step 36 е видим в приложението",
    taskLabel: "Задача",
    modelLabel: "Модел",
    dataLabel: "Разделяне на данните",
    trainLabel: "train реда",
    testLabel: "test реда",
    metricsTitle: "Текущи training метрики",
    metrics: {
      accuracy: "Accuracy",
      precision: "Precision needs_attention",
      recall: "Recall needs_attention",
      f1: "F1 needs_attention",
      iterations: "Training итерации",
      loss: "Финална training loss",
    },
    featuresTitle: "Входове на модела",
    numericFeatures: "Числови features",
    categoricalFeatures: "Категорийни features",
    ...
    safety:
      "Тази невронна мрежа е табличен prototype за сигнал за растеж. Тя не е ветеринарна диагноза, не е официална Cane Corso сертификация и не е image-based breed classifier.",
    futureWork:
      "Image neural networks остават future work, докато няма лицензиран и внимателно етикетиран Cane Corso photo dataset.",
  },
  it: {
