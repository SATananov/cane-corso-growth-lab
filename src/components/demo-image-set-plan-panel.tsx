...
const copy: Record<LanguageCode, {
  ...
  bg: {
    eyebrow: "Demo image set",
    title: "Малък куриран план за визуален dataset",
    descriptionSuffix:
      "Това е контролиран starter план: снимките трябва да са лицензирани, етикетирани и полезни за бъдещата проверка на снимки, breed classifier и visual similarity pipeline.",
    status: "Статус",
    minimumStarter: "Минимален старт",
    targetDemo: "Цел за demo",
    images: "снимки",
    viewTypes: "Типове изглед",
    gates: "Проверки преди demo употреба",
    required: "Задължително",
    recommended: "Препоръчително",
    manifest: "Колони за starter manifest",
    manifestDescription:
      "Всяка снимка трябва да бъде описана преди да се използва за demo модел или визуално сравнение. Manifest файлът е връзката между raw снимките, етикетите и бъдещите neural training notebooks.",
    column: "Колона",
    purpose: "Цел",
    metadataPurpose: "Задължителни metadata за източник, лиценз, порода/изглед, готовност и demo употреба.",
    milestoneSuffix:
      "Докато този milestone не е завършен, приложението трябва да показва visual AI като планиран или demo слой, не като обучено production доказателство.",
  },
  it: {
    eyebrow: "Demo image set",
