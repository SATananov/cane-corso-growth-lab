...
const copy = {
  ...
  bg: {
    ...
    title: "Един финален резултат, само след като снимката мине quality gate.",
    description:
      "Този contract определя как трябва да се държи бъдещият визуален резултат: rejected снимки блокират score-а, limited снимки показват warning, а accepted снимки комбинират classifier, similarity и geometry evidence.",
