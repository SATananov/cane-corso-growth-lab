...
const copy: Record<LanguageCode, {
  ...
  bg: {
    ...
    modelSections: [
      { title: "Regression слой", detail: "Обяснява растежа като крива и оценява очакваната точка за избраната възраст." },
      { title: "Classification слой", detail: "Подкрепя внимателни зони за преглед без медицински твърдения." },
