...
const copy: Record<LanguageCode, {
  ...
  bg: {
    ...
    title: "От стандартни пропорции към измерими характеристики в приложението.",
    description:
      "Референтният слой превръща стандартните размери в характеристики, които по-късно могат да се сравняват с ръчни измервания или точки от снимка.",
    steps: [
      ...
      "Използваме живия профил за контекст на височина и тегло в калкулатора.",
