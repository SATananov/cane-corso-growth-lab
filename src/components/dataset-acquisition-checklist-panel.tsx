...
const copy: Record<"en" | "bg" | "it", PanelCopy> = {
  ...
  bg: {
    ...
    title: "Снимките се събират през проверим manifest, не чрез случайно теглене.",
    description:
      "Тази стъпка превръща visual ML идеята в контролиран процес: всяка кандидат снимка получава източник, статус на права, породен label, тип изглед, качество и readiness label преди обучение на модел.",
    milestoneTitle: "Контролни gate-ове",
    manifestTitle: "Политика за starter manifest",
    columnsTitle: "Задължителни колони в manifest-а",
    rulesTitle: "Правила преди training",
    starterRowsTitle: "Примерни starter редове",
    headers: {
      milestone: "Етап",
      status: "Статус",
    ...
    trainingNote:
      "Невронните visual модели остават not ready for training, докато реалните image rows не са разрешени/одобрени, label-нати и разделени на train/validation/test.",
    yes: "Да",
    no: "Не",
  },
  it: {
