...
const copy: Record<LanguageCode, {
  ...
  bg: {
    ...
    workflow: [
      ...
      "Представяне на всяко куче като точка в координатно пространство от характеристики",
      "Обучение на регресионни модели за очаквани криви на растеж",
      "Използване на класификационни модели като сигнали за зона за преглед",
      "Свързване на доказателствата от Jupyter тетрадките с браузърния слой на приложението",
      "Показване на визуални доказателства директно в галерията на методологията",
      "Експорт на коефициенти и свързването им с логиката на калкулатора",
      "Използване на групиране и PCA за обяснение на профилни групи и визуални карти",
    ],
  },
  it: {
